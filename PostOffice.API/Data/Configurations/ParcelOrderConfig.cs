    ...
    public class ParcelOrderConfig : IEntityTypeConfiguration<ParcelOrder>
    {
        public void Configure(EntityTypeBuilder<ParcelOrder> builder)
        {
            ...
            builder.Property(e => e.receiver_phone)
                .HasMaxLength(50)
                .IsRequired();
            builder.Property(e => e.receiver_pincode)
                .HasMaxLength(10)
                .IsRequired();
            ...
            builder.Property(e => e.sender_phone)
                .HasMaxLength(20)
                .IsRequired();
            builder.Property(e => e.sender_pincode)
                .HasMaxLength(10)
                .IsRequired();
            ...
            builder.HasOne(d => d.SenderPincode).WithMany(p => p.ParcelOrders)
                .HasForeignKey(po => po.sender_pincode);

            builder.HasOne(d => d.ReceiverPincode).WithMany(p => p.ParcelOrders)
                            .HasForeignKey(po => po.receiver_pincode);
